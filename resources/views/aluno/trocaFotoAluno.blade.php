...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6 col-md-offset-1">
            <form method="POST" action="{{ route('fotoAluno.update', ['id' => Auth::user()->id]) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                @if (session('error'))
                ...
                <div class="card text-center">
                    ...
                    <img class="imagem_troca_avatar" src="/uploads/avatars/{{ Auth::user()->avatar }}" alt="imagem de perfil atual">
